...
public class MrcpRequestDecoder implements ProtocolDecoder
{
    ...
    public static MrcpRequest createRequest(String requestLine) throws ParseException
    {
        ...
        try
        {
            request.setMessageLength(Integer.parseInt(requestLineParts[REQUEST_LINE_MESSAGE_LENGTH_PART]));
        }
        ...
        try
        {
            request.setRequestID(Long.parseLong(requestLineParts[REQUEST_LINE_REQUEST_ID_PART]));
        }
        catch(NumberFormatException e)
        {
