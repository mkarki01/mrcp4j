...
public class MrcpMessageEncoder implements ProtocolEncoder
{
    ...
    private static int appendResponseLine(StringBuilder encodeBuf, MrcpResponse response)
    {
        ...
        encodeBuf.append(' ')
            .append(response.getRequestState());
        encodeBuf.append(CRLF);
        return version.length() + 1;
    }
    ...
    public void encode(ProtocolSession session, Object message, ProtocolEncoderOutput out) throws ProtocolViolationException
    {
        ...
        {
            throw new ProtocolViolationException("Unsupported message type: " + message.getClass()
                .getName());
        }
        ...
        {
            _encodeBuf.append(header.toString())
                .append(CRLF);
        }
        ...
        int bufferLengthLength = Integer.toString(bufferLength)
            .length();
