...
public class MrcpResponseDecoder
{
    ...
    public MrcpResponse createResponse(String responseLine) throws IOException, ParseException
    {
        ...
        try
        {
            response.setMessageLength(Integer.parseInt(responseLineParts[RESPONSE_LINE_MESSAGE_LENGTH_PART]));
        }
        ...
        try
        {
            response.setRequestID(Long.parseLong(responseLineParts[RESPONSE_LINE_REQUEST_ID_PART]));
        }
        catch(NumberFormatException e)
        {
        ...
        try
        {
            response.setStatusCode(Short.parseShort(responseLineParts[RESPONSE_LINE_STATUS_CODE_PART]));
        }
        catch(NumberFormatException e)
        {
        ...
        try
        {
            response.setRequestState(MrcpRequestState.fromString(responseLineParts[RESPONSE_LINE_REQUEST_STATE_PART]));
        }
