...
public class MrcpEventDecoder
{
    ...
    public MrcpEvent createEvent(String eventLine) throws IOException, ParseException
    {
        ...
        try
        {
            event.setMessageLength(Integer.parseInt(eventLineParts[EVENT_LINE_MESSAGE_LENGTH_PART]));
        }
        ...
        try
        {
            event.setEventName(MrcpEventName.fromString(eventLineParts[EVENT_LINE_EVENT_NAME_PART]));
        }
        ...
        try
        {
            event.setRequestID(Long.parseLong(eventLineParts[EVENT_LINE_REQUEST_ID_PART]));
        }
        catch(NumberFormatException e)
        {
        ...
        try
        {
            event.setRequestState(MrcpRequestState.fromString(eventLineParts[EVENT_LINE_REQUEST_STATE_PART]));
        }
        catch(IllegalArgumentException e)
        {
