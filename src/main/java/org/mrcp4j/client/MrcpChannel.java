 ...
 * <p/>
 * To construct a {@code MrcpChannel} instance use {@link org.mrcp4j.client.MrcpProvider#createChannel(String, java.net.InetAddress, int, String)}.
 *
...
public class MrcpChannel implements MrcpMessageHandler
{
    ...
    MrcpChannel(String channelID, MrcpSocket socket) throws IllegalValueException
    {
        ...
        _socket = socket;
        _requestID = System.currentTimeMillis();
     ...
     */
    public synchronized MrcpResponse sendRequest(MrcpRequest request) throws IOException, MrcpInvocationException, InterruptedException
    {
